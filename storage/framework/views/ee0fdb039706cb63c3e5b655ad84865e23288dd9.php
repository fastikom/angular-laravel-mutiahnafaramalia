...
<head>
	...
	<script src="<?php echo e(asset('app/services/myServices.js')); ?>"></script>
	<script src="<?php echo e(asset('app/helper/myHelper.js')); ?>"></script>

	<!-- App Controller -->
	<script src="<?php echo e(asset('/app/controllers/ProductController.js')); ?>"></script>
	<style>
